% MASTER 3 -- Scannable flip-flop = D flip-flop preceded by a 2:1 multiplexer.
% SCAN selects D (normal) or SI (shift). Covers Q3 & Q20 directly; it is the unit
% cell of the scan chain (Q18) and the BIST register (Q17).
