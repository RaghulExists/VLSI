% Q02 -- Functional equivalence at various levels of abstraction (logic verification).
% Behavioral = RTL = Structural = Physical, each comparison feeding the relevant analysis.
