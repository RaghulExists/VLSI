% MASTER 5 (textbook form) -- CMOS pseudo-static D latch / "D flip-flop" (Q4):
% TWO transmission gates + TWO inverters (NOT gates), matching the textbook figure.
% Forward: D -TG1(phi)-> node A -inv1-> Q.  Feedback loop (holds A): Q -inv2-> -TG2(phi-bar)-> A.
