% Q04 -- CMOS pseudo-static D flip-flop using transmission gates.
% Master TG (phi) samples D into an inverter; slave TG (phi-bar) closes the feedback
% inverter loop to latch/hold (the feedback "refreshes" -> pseudo-static).
